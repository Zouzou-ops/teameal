    ...
    return (
        <nav className="fixed left-0 top-0 w-full z-10  px-16 ">
            <div className="max-[1240px] m-auto flex justify-between items-center p-4 ">
                ...
                />
                <ul className=" md:hidden flex text-lumblue space-x-7" >
                    <li className="p-4">
                    ...
                    <li className="p-4">
                     ...
                     <div className="md:hidden">
                        <a href="/register" class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-lumblue rounded-full shadow-md group">
                            ...
                            <span class="absolute flex items-center justify-center w-full h-full bg-lumblue text-lumpink transition-all duration-300 transform group-hover:translate-x-full ease">S'inscrire</span>
